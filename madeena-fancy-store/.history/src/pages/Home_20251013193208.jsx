...
export default function Home(){
  return (
    <div>
      <section className="bg-gradient-to-r from-blue-600 to-cyan-500 rounded-lg p-8 mb-6">
        <div className="flex flex-col md:flex-row items-center gap-6">
          <div className="w-32 h-32 flex-shrink-0">
            <img src="/src/assets/brand.png" alt="Madeena Store Logo" className="w-full h-full object-cover rounded-full border-4 border-white shadow-lg" />
          </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded shadow text-center hover:shadow-lg transition border-2 border-purple-200">
            <img src="/src/assets/shop1.png" alt="Bangles" className="h-28 mx-auto object-cover rounded" />
            <h4 className="mt-2 font-medium text-purple-600">Bangles</h4>
          </div>
          <div className="bg-white p-4 rounded shadow text-center hover:shadow-lg transition border-2 border-purple-200">
            <img src="/src/assets/shop1.png" alt="Dresses" className="h-28 mx-auto object-cover rounded" />
            <h4 className="mt-2 font-medium text-purple-600">Dresses</h4>
          </div>
          <div className="bg-white p-4 rounded shadow text-center hover:shadow-lg transition border-2 border-purple-200">
            <img src="/src/assets/shop1.png" alt="Attar" className="h-28 mx-auto object-cover rounded" />
            <h4 className="mt-2 font-medium text-purple-600">Attar</h4>
          </div>
          <div className="bg-white p-4 rounded shadow text-center hover:shadow-lg transition border-2 border-purple-200">
            <img src="/src/assets/shop1.png" alt="Wedding Items" className="h-28 mx-auto object-cover rounded" />
